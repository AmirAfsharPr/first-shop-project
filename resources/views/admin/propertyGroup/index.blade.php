                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">لیست گروه ویژگی ها</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="btn-popup ">
                                <a href="{{route('propertyGroups.create')}}" class="btn btn-secondary">افزوردن گروه ویژگی جدید</a>
                            </div>
                                    ...
                                    @foreach($properties as $property)
                                        <tr class="jsgrid-filter-row">
                                            ...
                                            <td class="jsgrid-cell" style="width: 100px;">
                                                <a href="{{route('propertyGroups.edit', $property)}}" class="btn btn-warning btn-sm btn-warning mb-0 b-r-4" style="display: inline-block; padding: 0.5rem 1.5rem;!important;" >ویرایش</a>
                                                <form class="d-inline-block" action="{{route('propertyGroups.destroy', $property)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
