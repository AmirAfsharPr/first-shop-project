                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="sabtpr" class="needs-validation add-product-form" novalidate="" method="post" action="{{route('products.update', $product)}}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="form">
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="form">
                                                <div class="form-group mb-3  row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control " id="validationCustom00" type="text" required="" name="name" value="{{$product->name}}">
                                                ...
                                                <div class="form-group mb-3  row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control " id="validationCustom01" type="text" required="" name="slug" value="{{$product->slug}}">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control " id="validationCustom02" type="number" required="" name="cost" value="{{$product->cost}}">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control " id="validationCustom05" type="text" required="" name="description" value="{{$product->description}}">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="add-product">
                                                    <div class="row">
                                                        <div class="col-xl-3 col-sm-4 mb-0">
                                                            <label class="p-3 h6">عکس اصلی محصول :</label>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <ul class="file-upload-product d-flex flex-row">
                                                                ...
                                                                <li class="mx-2">
                                                                    <img src="{{str_replace('public', '/storage', $product->image)}}" style="width: 100px">
                                                                </li>
                                                            </ul>
                                                        </div>
                                            ...
                                            <div class="offset-xl-3 offset-sm-4 mt-5">
                                                <button id="sabt" type="submit" class="btn btn-primary">ویرایش</button>
